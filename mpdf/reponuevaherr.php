...
join status_uso u on u.id_status_uso = h.id_status_uso join status_prestamo p on p.id_status_prestamo = h.id_status_prestamo join condicion cd on cd.id_condicion = h.id_condicion where h.id_status_uso = 1";
    $res = $con->query($sql);
	$tabla="";
	$tabla .= "<table>
            <tr>
...
$html = "<img src='img/inventool.png' width='200px'><hr><p align ='center'><font face='Black Ops One'>REPORTE <BR> NUEVAS HERRAMIENTAS</font><br></p>";
$html .= "<hr>";
$html .= selectTabla();
$pdf= new mPDF('c');
$pdf->WriteHTML($html);
